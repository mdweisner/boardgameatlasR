...
Please note: this only covers the [search of the BGA API](https://www.boardgameatlas.com/api/docs/search), and more query features will hopefully be added in the future.
